...
<Link to=""><i className="fa-brands fa-linkedin-in m-2 social_icon_footer" style={{"color": "#ffffff"}}></i></Link>
              ...
              <div className="col-lg-3 col-md-3-col-sm-12">
              <img src={require("../assets/logo-no-background.png")} alt="footer-logo" title="footer-logo" className="img-fluid ba9ma_footer" loading="lazy"/>         
                   </div>
              
            </div>
            <h5 className="text-center copywrite">جميع الحقوق محفوظة لدى أكاديمية الذكاء التربوي
            </h5>
          </div>
        </div>
      </footer>
